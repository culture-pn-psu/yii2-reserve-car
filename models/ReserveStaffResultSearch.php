...
/**
 * ReserveCarStaffSearch represents the model behind the search form about `backend\modules\reserveCar\models\ReserveCar`.
 */
class ReserveStaffResultSearch extends ReserveCar
{
    /**
     * @inheritdoc
     */
